...
This dashboard provides end-to-end analysis of HR data to identify trends in:

Employee Attrition

Salary Slabs & Monthly Income Distribution
...
Demographic insights (Age, Gender, Education, Marital Status, etc.)
...
✔ Filters for Age, Job Role, Department, Salary Slab, etc.
...
Designing reports with storytelling

Understanding HR metrics & KPIs

Publishing and documenting Power BI projects
